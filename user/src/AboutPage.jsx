    ...
    return (
        ...
        *{box-sizing:border-box;margin:0;padding:0;}`}
            ...
            <div style={{ maxWidth: 860, margin: "0 auto", padding: "64px 24px 96px" }}>
                ...
                {/* Title — "transformation" underlined with yellow */}
                ...
                <div style={{ borderRadius: 24, overflow: "hidden", marginBottom: 56, boxShadow: "0 12px 40px rgba(26,51,41,0.12)" }}>
                    <img
                        src="https://copilot.microsoft.com/shares/GjZyVLgbwBpL36a1KpYLw"
                ...
                <div style={{ textAlign: "center", margin: "0 auto 56px", maxWidth: 600 }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 18, justifyContent: "center" }}>
                        <div style={{ height: 1, width: 48, background: "rgba(45,107,80,0.2)" }} />
                        <span style={{ fontSize: 12.5, color: "#7a9e8e", fontWeight: 600, letterSpacing: 0.5 }}>The Chrisalis Philosophy</span>
                        <div style={{ height: 1, width: 48, background: "rgba(45,107,80,0.2)" }} />
                    </div>
                </div>
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <div style={{ width: 6, height: 6, borderRadius: "50%", background: "linear-gradient(135deg,#3d9b73,#1a6fa0)", flexShrink: 0 }} />
                {/* yellow left border on title text */}
                <h2 style={{ fontFamily: "'Syne',sans-serif", fontSize: 20, fontWeight: 800, color: "#1a3329", borderBottom: "2px solid rgba(245,230,66,0.5)", paddingBottom: 2 }}>{title}</h2>
            </div>
            <div style={{ paddingLeft: 18, borderLeft: "2px solid rgba(79,158,122,0.2)" }}>
                {String(children).split("\n\n").map((p, i) => (
                    <p key={i} style={{ fontSize: 15, color: "#4a6a5e", lineHeight: 1.9, marginBottom: i < String(children).split("\n\n").length - 1 ? 14 : 0 }}>
                        {p}
                    </p>
                ))}
            </div>
