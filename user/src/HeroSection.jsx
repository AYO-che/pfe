...
const STATS2 = [
  { value: "12K+", label: "Members transformed", icon: "👥" },
  { value: "98%", label: "Satisfaction rate", icon: "⭐" },
  { value: "50+", label: "Expert specialists", icon: "🏥" },
  { value: "3×", label: "Faster results", icon: "🚀" },
];

const PILLS = ["No sugar added", "High protein", "Low calories", "Heart healthy", "Vitamin rich", "Anti-inflammatory"];
const PILL_POS = [
  { top: "-18px", left: "8%" }, { top: "-18px", left: "40%" },
  { top: "-18px", right: "6%" }, { bottom: "-18px", left: "6%" },
  { bottom: "-18px", left: "36%" }, { bottom: "-18px", right: "4%" },
];
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 1180, margin: "0 auto", width: "100%", padding: mob ? "56px 24px 48px" : w < 1024 ? "60px 40px" : "0 56px", display: "flex", flexDirection: mob ? "column" : "row", alignItems: "center", gap: mob ? 36 : 24 }}>
          ...
          <div style={{ flex: "0 0 46%", width: mob ? "100%" : "46%", paddingRight: mob ? 0 : 32 }}>
            ...
            <p className="h-sub" style={{ fontSize: 16, color: "#4a6a5e", lineHeight: 1.75, maxWidth: 420, marginBottom: 36 }}>
              ...
              <strong style={{ color: "#2d6b50", fontWeight: 600 }}>Chrisalis</strong>{" "}
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: mob ? 48 : 64, ...fade(0) }}>
            <h2 style={{ fontFamily: "'Syne',sans-serif", fontSize: "clamp(30px,4.5vw,52px)", fontWeight: 800, color: "#1a3329", letterSpacing: -1.5, lineHeight: 1.08, marginBottom: 16 }}>
              Tools built for{" "}
              <span style={{ background: "linear-gradient(135deg,#2d9e7a,#1a5e44)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                your goals
              </span>
            </h2>
            <p style={{ fontSize: 16.5, color: "#5a7a6e", maxWidth: 500, margin: "0 auto", lineHeight: 1.75 }}>
              Whether you want to lose weight, eat better, or simply feel great — Chrisalis gives you the right tools to get there.
            </p>
          </div>
          ...
          {/* CTA strip */}
          <div style={{ marginTop: mob ? 48 : 64, background: "linear-gradient(135deg,#1a5e44,#2d9e7a)", borderRadius: 22, padding: mob ? "28px 24px" : "32px 44px", display: "flex", flexDirection: mob ? "column" : "row", alignItems: "center", justifyContent: "space-between", gap: 20, boxShadow: "0 12px 36px rgba(45,107,80,0.22)", ...fade(0.65) }}>
            <div>
              <div style={{ fontFamily: "'Syne',sans-serif", fontSize: mob ? 20 : 24, fontWeight: 800, color: "#fff", marginBottom: 6, lineHeight: 1.25 }}>
                Want to see real results?<br />
                <span style={{ opacity: 0.85, fontWeight: 700, fontSize: mob ? 17 : 20 }}>Start your programme today.</span>
              </div>
              <div style={{ fontSize: 13.5, color: "rgba(255,255,255,0.7)" }}>No credit card · Free 3-day trial</div>
            </div>
            <button
              onClick={() => navigate("/calories")}
              style={{ background: "#fff", color: "#1a5e44", border: "none", borderRadius: 999, padding: "13px 30px", fontSize: 15, fontWeight: 700, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", whiteSpace: "nowrap", boxShadow: "0 4px 16px rgba(0,0,0,0.12)", flexShrink: 0 }}
            >
              Get Started Free →
            </button>
          </div>
...
const PERKS = [
  { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2C6 9 4 13 4 16a8 8 0 0 0 16 0c0-3-2-7-8-14z" /></svg>, title: "Personalised Hydration", desc: "Daily water goals adapted to your body and activity level." },
  { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12" /></svg>, title: "Progress Tracking", desc: "Visual charts that show your transformation week by week." },
  { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" /><path d="M9 3v18" /><path d="M3 9h6" /><path d="M3 15h6" /><path d="M15 3v18" /><path d="M15 9h6" /><path d="M15 15h6" /></svg>, title: "AI Meal Planner", desc: "Smart weekly menus built around your goals and tastes." },
  { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></svg>, title: "Calorie & Macro Tracker", desc: "Log every meal and understand exactly what you're eating." },
  { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></svg>, title: "Nutritionist Sessions", desc: "1-on-1 expert guidance tailored to your health journey." },
  { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="16" y1="13" x2="8" y2="13" /></svg>, title: "Custom Health Plan", desc: "A full programme designed specifically for your body type." },
  { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg>, title: "24/7 Support Chat", desc: "Always-on help from your dedicated health coach." },
  { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M3 5v14" /><path d="M7 5v14" /><path d="M11 5v14" /><path d="M15 5v14" /><path d="M19 5v14" /><rect x="1" y="3" width="22" height="18" rx="2" /></svg>, title: "Barcode Food Scanner", desc: "Instantly identify any product and log it with one scan." },
  { icon: <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" /></svg>, title: "Weekly Health Insights", desc: "Detailed reports on sleep, stress, nutrition and energy." },
];

function PlansInner({ vis, mob }) {
  return (
    <section style={{ background: "linear-gradient(135deg,#d7ecfa 0%,#d7f8da 100%)", padding: mob ? "64px 24px 72px" : "88px 24px 100px", fontFamily: "'DM Sans',sans-serif" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>

        {/* Header */}
        <div style={{ textAlign: "center", marginBottom: mob ? 44 : 60, opacity: vis ? 1 : 0, transform: vis ? "translateY(0)" : "translateY(20px)", transition: "all 0.65s ease" }}>
          <span style={{ display: "inline-flex", alignItems: "center", gap: 7, background: "rgba(255,255,255,0.85)", border: "1px solid rgba(79,158,122,0.25)", borderRadius: 999, padding: "5px 16px 5px 8px", fontSize: 12.5, fontWeight: 600, color: "#2d6b50", marginBottom: 18, boxShadow: "0 2px 10px rgba(45,107,80,0.08)" }}>
          ...
          <h2 style={{ fontFamily: "'Syne',sans-serif", fontSize: "clamp(28px,4vw,50px)", fontWeight: 800, color: "#1a3329", letterSpacing: -1.5, lineHeight: 1.08, marginBottom: 14 }}>
            Everything you get{" "}
            <span style={{ background: "linear-gradient(135deg,#2d9e7a,#1a5e44)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>when you subscribe</span>
          </h2>
          <p style={{ fontSize: 16, color: "#4a6a5e", maxWidth: 480, margin: "0 auto", lineHeight: 1.75 }}>
            One subscription. Nine powerful tools. All designed to guide your transformation from day one.
          </p>
        </div>

        {/* 3×3 grid */}
        <div style={{ display: "grid", gridTemplateColumns: mob ? "1fr" : "repeat(3,1fr)", gap: mob ? 14 : 20 }}>
          {PERKS.map((p, i) => <PerkCard key={p.title} perk={p} delay={i * 0.07} vis={vis} />)}
        </div>

        {/* CTA */}
        <div style={{ marginTop: mob ? 44 : 60, textAlign: "center", opacity: vis ? 1 : 0, transform: vis ? "translateY(0)" : "translateY(16px)", transition: "all 0.65s ease 0.7s" }}>
          <button style={{ background: "linear-gradient(135deg,#3d9b73,#2a6b4f)", color: "#fff", border: "none", borderRadius: 999, padding: "14px 36px", fontSize: 15, fontWeight: 700, cursor: "pointer", fontFamily: "'DM Sans',sans-serif", boxShadow: "0 6px 20px rgba(45,107,80,0.32)", letterSpacing: 0.3 }}>
            Start My Journey →
          </button>
          <div style={{ marginTop: 12, fontSize: 13, color: "#5a7a6e" }}>Free 3-day trial · No credit card required</div>
        </div>
...
function PerkCard({ perk, delay, vis }) {
  const [hov, setHov] = useState(false);
  return (
    <div onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)} style={{ background: hov ? "#fff" : "rgba(255,255,255,0.65)", backdropFilter: "blur(8px)", border: `1.5px solid ${hov ? "rgba(79,158,122,0.3)" : "rgba(255,255,255,0.9)"}`, borderRadius: 18, padding: "24px 20px", display: "flex", gap: 16, alignItems: "flex-start", boxShadow: hov ? "0 12px 32px rgba(45,107,80,0.12)" : "0 2px 8px rgba(0,0,0,0.04)", transform: hov ? "translateY(-4px)" : "translateY(0)", transition: "all 0.25s ease", opacity: vis ? 1 : 0, transitionDelay: `${delay}s` }}>
      <div style={{ width: 50, height: 50, borderRadius: 14, background: hov ? "linear-gradient(135deg,#3d9b73,#2a6b4f)" : "linear-gradient(135deg,#e8f5e9,#e3f2fd)", display: "flex", alignItems: "center", justifyContent: "center", color: hov ? "#fff" : "#2d7a4f", flexShrink: 0, transition: "all 0.25s ease", boxShadow: hov ? "0 6px 16px rgba(45,107,80,0.3)" : "none" }}>
        {perk.icon}
      </div>
      <div>
        <div style={{ fontFamily: "'Syne',sans-serif", fontSize: 15, fontWeight: 800, color: "#1a3329", marginBottom: 5 }}>{perk.title}</div>
        <div style={{ fontSize: 11.5, color: "#5a7a6e", lineHeight: 1.55 }}>{perk.desc}</div>
      </div>
    </div>
  );
}
...
const TESTIMONIALS = [
  {
    name: "Sarah M.", goal: "Lost 18kg",
    quote: "Chrisalis completely changed how I think about food. In 4 months I lost 18kg without ever feeling deprived.",
    before: B1,
    after: A1,
    tag: "Weight Loss", accent: "#2d7a4f", color: "#e8f5e9",
  },
  {
    name: "Karim A.", goal: "Gained muscle & energy",
    quote: "The personalised plan and nutritionist sessions gave me the structure I needed. I feel stronger than ever at 42.",
    before: B2,
    after: A2,
    tag: "Muscle Gain", accent: "#1a6fa0", color: "#e3f2fd",
  },
  {
    name: "Lina R.", goal: "Managed diabetes",
    quote: "My blood sugar is finally under control. The AI meal planner takes all the guesswork out of eating healthy.",
    before: B3,
    after: A3,
    tag: "Health", accent: "#7a3fa0", color: "#f3e8fd",
  },
];
        ...
        <div style={{ marginTop: 80 }}>
          <div style={{ textAlign: "center", marginBottom: 52, opacity: vis ? 1 : 0, transform: vis ? "translateY(0)" : "translateY(20px)", transition: "all 0.65s ease 0.3s" }}>
            ...
            <h2 style={{ fontFamily: "'Syne',sans-serif", fontSize: "clamp(24px,3.5vw,42px)", fontWeight: 800, color: "#1a3329", letterSpacing: -1.5, lineHeight: 1.08 }}>
              Before &{" "}
              <span style={{ background: "linear-gradient(135deg,#2d9e7a,#1a5e44)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>after Chrisalis</span>
            </h2>
          </div>
...
const REVIEWS = [
  {
    ...
    quote: "Chrisalis completely changed my relationship with food. The AI meal planner felt like having a personal nutritionist in my pocket. I finally understood what my body actually needed.",
  ...
  {
    name: "Karim B.",
    role: "Gained muscle & improved energy",
    quote: "I was skeptical at first, but after just two weeks on my custom plan I had more energy than I've had in years. The specialist sessions made all the difference — real advice, real results.",
  ...
  {
    name: "Amira L.",
    role: "Managing diabetes through nutrition",
    quote: "My doctor was amazed at my last check-up. The chronic disease plan on Chrisalis taught me exactly how to eat for my condition. I feel in control for the first time in years.",
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: mob ? 44 : 64, opacity: vis ? 1 : 0, transform: vis ? "translateY(0)" : "translateY(20px)", transition: "all 0.65s ease" }}>
          ...
          <p style={{ fontSize: 16, color: "#5a7a6e", maxWidth: 460, margin: "0 auto", lineHeight: 1.75 }}>
            Real members, real results. Here's what the Chrisalis community has to say.
          </p>
        </div>

        {/* Reviews — alternating layout */}
...
function ReviewCard({ review, flip, mob, vis, delay }) {
  ...
  return (
    <div
      ...
      style={{
        display: "flex", flexDirection: mob ? "column" : flip ? "row-reverse" : "row",
        gap: mob ? 0 : 0, borderRadius: 24, overflow: "hidden",
        boxShadow: hov ? "0 20px 50px rgba(26,51,41,0.13)" : "0 4px 16px rgba(0,0,0,0.07)",
    ...
    >
      ...
      <div style={{ flex: "0 0 42%", minHeight: mob ? 220 : 300, overflow: "hidden", position: "relative" }}>
        ...
        {/* gradient overlay */}
        <div style={{
          position: "absolute", inset: 0, background: flip
            ? "linear-gradient(to left, rgba(26,51,41,0.25), transparent)"
            : "linear-gradient(to right, rgba(26,51,41,0.25), transparent)"
        }} />
      </div>

      {/* Text side */}
      <div style={{
        flex: 1, padding: mob ? "28px 24px" : "40px 44px",
        display: "flex", flexDirection: "column", justifyContent: "center", gap: 20,
        background: hov ? "linear-gradient(135deg,#f7fdf9,#f0f9ff)" : "#fff",
        transition: "background 0.3s ease",
      }}>
        {/* Stars */}
        <div style={{ display: "flex", gap: 4 }}>
          {Array.from({ length: review.stars }).map((_, i) => (
            <svg key={i} width="18" height="18" viewBox="0 0 24 24" fill="#f5a623" stroke="none">
        ...
        {/* Quote */}
        <p style={{
          fontSize: mob ? 15 : 17, color: "#2a4a3e", lineHeight: 1.8, fontStyle: "italic", margin: 0,
          borderLeft: "3px solid #4f9e7a", paddingLeft: 18
        }}>
          "{review.quote}"
        </p>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          <img src={review.avatar} alt={review.name}
            style={{ width: 50, height: 50, borderRadius: "50%", objectFit: "cover", border: "2px solid #e8f5e9", flexShrink: 0 }} />
          <div>
...
function ContactButton({ onClick }) {
  ...
  return (
    <button
      ...
      onClick={onClick}
      style={{
        position: "fixed", right: 24, bottom: 32, zIndex: 999,
        background: "#d7ecfa",
        color: "#1a5e44", border: "none", borderRadius: 999,
        padding: hov ? "13px 22px" : "13px 18px",
        fontSize: 14, fontWeight: 700, cursor: "pointer",
        fontFamily: "'DM Sans',sans-serif",
        boxShadow: hov ? "0 10px 28px rgba(45,107,80,0.45)" : "0 4px 18px rgba(45,107,80,0.35)",
...
function ContactModal({ onClose, mob }) {
  ...
  const inp = (extra = {}) => ({
    ...
    border: "1.5px solid rgba(79,158,122,0.25)",
    borderRadius: 8, padding: "8px 11px",
    fontSize: 12.5, fontFamily: "'DM Sans',sans-serif",
    color: "#1a3329", background: "#f7fdf9",
