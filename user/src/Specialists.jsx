...
const SPECIALISTS = [
  { id:1, name:"Dr. Sarah Mitchell", title:"Clinical Nutritionist", gender:"female", avatar:"https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=400&q=80", cover:"https://images.unsplash.com/photo-1504813184591-01572f98c85f?w=800&q=80", education:"Ph.D. Nutritional Sciences — Harvard University", workplace:"Boston Medical Center, USA", specialties:["Weight Management","Diabetes","Sports Nutrition"], rating:4.9, reviewCount:134, badge:"Top Rated", badgeColor:"#2d7a4f", gender2:"female", comments:[{id:1,user:"Amira L.",avatar:"https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=80&q=80",text:"Dr. Sarah completely transformed my approach to eating. My blood sugar is finally stable!",date:"Feb 2026",stars:5},{id:2,user:"Karim B.",avatar:"https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=80&q=80",text:"Incredibly professional and genuinely caring. Lost 14kg in 5 months following her plan.",date:"Jan 2026",stars:5}]},
  { id:2, name:"Dr. James Carter", title:"Sports & Performance Dietitian", gender:"male", avatar:"https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=400&q=80", cover:"https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800&q=80", education:"M.Sc. Sports Dietetics — UCL London", workplace:"London Sport & Wellness Clinic, UK", specialties:["Muscle Gain","Athletic Performance","Recovery Nutrition"], rating:4.8, reviewCount:98, badge:"Expert", badgeColor:"#1a6fa0", comments:[{id:1,user:"Lina R.",avatar:"https://images.unsplash.com/photo-1580489944761-15a19d654956?w=80&q=80",text:"Best sports nutritionist I've worked with. My marathon time improved significantly.",date:"Mar 2026",stars:5}]},
  { id:3, name:"Dr. Nadia Benali", title:"Pediatric & Family Nutritionist", gender:"female", avatar:"https://images.unsplash.com/photo-1551836022-deb4988cc6c0?w=400&q=80", cover:"https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=800&q=80", education:"M.D. Pediatric Nutrition — Sorbonne University, Paris", workplace:"Hôpital Necker, Paris, France", specialties:["Child Nutrition","Family Meal Planning","Eating Disorders"], rating:4.9, reviewCount:201, badge:"Most Trusted", badgeColor:"#7a3fa0", comments:[{id:1,user:"Sara M.",avatar:"https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?w=80&q=80",text:"Dr. Nadia helped my entire family adopt healthier habits. My kids actually enjoy eating vegetables now!",date:"Feb 2026",stars:5}]},
  { id:4, name:"Dr. Omar Khalil", title:"Chronic Disease & Gut Health Specialist", gender:"male", avatar:"https://images.unsplash.com/photo-1582750433449-648ed127bb54?w=400&q=80", cover:"https://images.unsplash.com/photo-1547592166-23ac45744acd?w=800&q=80", education:"Ph.D. Gastroenterology & Nutrition — Cairo University", workplace:"Al-Salam International Hospital, Cairo, Egypt", specialties:["IBS & Gut Health","Diabetes","Anti-inflammatory Diet"], rating:4.7, reviewCount:87, badge:"Specialist", badgeColor:"#c07a00", comments:[{id:1,user:"Youssef A.",avatar:"https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=80&q=80",text:"My IBS symptoms are 90% gone after 3 months. Dr. Omar's gut health protocol is life-changing.",date:"Jan 2026",stars:5}]},
  { id:5, name:"Dr. Yasmine Larabi", title:"Weight Loss & Hormonal Health Expert", gender:"female", avatar:"https://images.unsplash.com/photo-1594824476967-48c8b964273f?w=400&q=80", cover:"https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=800&q=80", education:"M.Sc. Endocrine Nutrition — University of Algiers", workplace:"Clinique El Azhar, Algiers, Algeria", specialties:["PCOS","Thyroid Nutrition","Intermittent Fasting"], rating:4.8, reviewCount:116, badge:"Rising Star", badgeColor:"#2d7a4f", comments:[{id:1,user:"Fatima Z.",avatar:"https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=80&q=80",text:"Finally a nutritionist who understands PCOS! Lost 9kg and my cycles are regular for the first time.",date:"Mar 2026",stars:5}]},
  { id:6, name:"Dr. Rafael Moreno", title:"Cardiovascular Nutrition Specialist", gender:"male", avatar:"https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=400&q=80", cover:"https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=800&q=80", education:"Ph.D. Cardiology & Nutrition — University of Barcelona", workplace:"Hospital Clínic de Barcelona, Spain", specialties:["Heart Health","Cholesterol Management","Mediterranean Diet"], rating:4.9, reviewCount:178, badge:"Top Rated", badgeColor:"#c0392b", comments:[{id:1,user:"Maria C.",avatar:"https://images.unsplash.com/photo-1544723795-3fb6469f5b39?w=80&q=80",text:"My cardiologist was amazed at my improved cholesterol levels after 4 months with Dr. Rafael.",date:"Feb 2026",stars:5}]},
];
    ...
    <div className="overlay" onClick={onClose}>
      <div className="book-modal" onClick={e=>e.stopPropagation()}>
        <div style={{background:"linear-gradient(135deg,#1a3329,#2d6b50)",padding:"20px 22px",borderRadius:"28px 28px 0 0",display:"flex",alignItems:"center",gap:12}}>
          <img src={sp.avatar} alt={sp.name} style={{width:46,height:46,borderRadius:"50%",objectFit:"cover",border:"2px solid rgba(255,255,255,0.3)",flexShrink:0}}/>
          <div style={{flex:1}}>
            <div style={{fontFamily:"'Syne',sans-serif",fontSize:15,fontWeight:800,color:"#fff"}}>{sp.name}</div>
            <div style={{fontSize:12,color:"rgba(255,255,255,0.6)",marginTop:2}}>{sp.title}</div>
          </div>
...
function SpecialistModal({ sp, onClose, onBook }) {
  ...
  const [comments,setComments]=useState(sp.comments);

  const handleSubmit=()=>{
    if(!text.trim()||!userName.trim())return;
    setComments(p=>[...p,{id:Date.now(),user:userName,avatar:sp.gender==="female"?"https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=80&q=80":"https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=80&q=80",text,date:"Mar 2026",stars}]);
    setSubmitted(true);
    ...
    <div className="overlay" onClick={onClose}>
      <div className="sp-modal" onClick={e=>e.stopPropagation()}>
        <div style={{position:"relative",height:200}}>
          <img src={sp.cover} alt="" style={{width:"100%",height:"100%",objectFit:"cover",display:"block"}}/>
          ...
          <img src={sp.avatar} alt={sp.name} style={{position:"absolute",bottom:-32,left:24,width:76,height:76,borderRadius:"50%",objectFit:"cover",border:"4px solid #fff",boxShadow:"0 4px 16px rgba(0,0,0,0.2)"}}/>
          <div style={{position:"absolute",bottom:14,right:20,background:sp.badgeColor,color:"#fff",borderRadius:999,padding:"4px 14px",fontSize:11.5,fontWeight:700}}>{sp.badge}</div>
        </div>

        <div style={{padding:"44px 28px 32px"}}>
          <div style={{marginBottom:20}}>
            <div style={{fontFamily:"'Syne',sans-serif",fontSize:22,fontWeight:800,color:"#1a3329",marginBottom:4}}>{sp.name}</div>
            <div style={{fontSize:14,color:"#4f9e7a",fontWeight:600,marginBottom:12}}>{sp.title}</div>
            <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:14}}>
              <Stars count={Math.round(sp.rating)}/><span style={{fontFamily:"'Syne',sans-serif",fontSize:15,fontWeight:800,color:"#1a3329"}}>{sp.rating}</span><span style={{fontSize:13,color:"#5a7a6e"}}>· {sp.reviewCount} reviews</span>
            </div>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:14}}>
              {[{label:"Education",val:sp.education,col:"1 / -1"},{label:"Workplace",val:sp.workplace}].map(item=>(
            ...
            <div style={{display:"flex",flexWrap:"wrap",gap:6}}>
              {sp.specialties.map(s=><span key={s} className="sp-tag">{s}</span>)}
            </div>
          </div>
              ...
              {comments.map(c=>(
                <div key={c.id} className="sp-comment-card">
                  <div style={{display:"flex",gap:12}}>
                    <img src={c.avatar} alt={c.user} style={{width:40,height:40,borderRadius:"50%",objectFit:"cover",flexShrink:0}}/>
                    <div style={{flex:1}}>
                      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:4}}>
                        <span style={{fontSize:13.5,fontWeight:700,color:"#1a3329"}}>{c.user}</span>
                        <span style={{fontSize:11.5,color:"#5a7a6e"}}>{c.date}</span>
                      </div>
                      <Stars count={c.stars}/>
                      <p style={{fontSize:13.5,color:"#2a4a3e",lineHeight:1.7,marginTop:6,fontStyle:"italic"}}>"{c.text}"</p>
                    </div>
                  </div>
                </div>
              ))}
...
export default function Specialists() {
  ...
  const handleConfirm=({sp,date,slot})=>{setBookingSp(null);navigate("/consultation-payment",{state:{sp,date,slot}});};
      ...
      <section style={{background:"linear-gradient(135deg,#1a3329 0%,#2d6b50 60%,#1a3329 100%)",padding:"64px 24px 60px",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{position:"relative",maxWidth:680,margin:"0 auto",textAlign:"center"}}>
          ...
          <div className="sp-fade-up" style={{display:"flex",justifyContent:"center",gap:32,marginTop:36,animationDelay:"0.3s"}}>
            {[["6","Specialists"],["500+","Patients helped"],["4.85","Avg. rating"]].map(([num,label])=>(
          ...
          {filtered.map((sp,i)=>(
            <div key={sp.id} className="sp-card sp-fade-up" style={{animationDelay:`${i*0.1}s`}} onClick={()=>setSelected(sp)}>
              <div style={{position:"relative",height:160,overflow:"hidden"}}>
                ...
                <div style={{position:"absolute",top:14,left:14,background:sp.badgeColor,color:"#fff",borderRadius:999,padding:"4px 12px",fontSize:11,fontWeight:700}}>{sp.badge}</div>
                <img src={sp.avatar} alt={sp.name} style={{position:"absolute",bottom:-28,left:20,width:64,height:64,borderRadius:"50%",objectFit:"cover",border:"3px solid #fff",boxShadow:"0 4px 14px rgba(0,0,0,0.18)"}}/>
              </div>
              <div style={{padding:"36px 20px 14px"}}>
                <div style={{fontFamily:"'Syne',sans-serif",fontSize:17,fontWeight:800,color:"#1a3329",marginBottom:3}}>{sp.name}</div>
                <div style={{fontSize:13,color:"#4f9e7a",fontWeight:600,marginBottom:10}}>{sp.title}</div>
                <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:12}}>
                  <Stars count={Math.round(sp.rating)}/><span style={{fontSize:13,fontWeight:700,color:"#1a3329"}}>{sp.rating}</span><span style={{fontSize:12,color:"#5a7a6e"}}>({sp.reviewCount})</span>
                </div>
                <div style={{display:"flex",flexWrap:"wrap",gap:6}}>
                  {sp.specialties.map(s=><span key={s} className="sp-tag">{s}</span>)}
                </div>
