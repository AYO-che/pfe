...
.rp-step.active .rp-step-dot {
  ...
  background: #2d6b50;
  color: #fff;
  box-shadow: 0 0 0 4px rgba(45,107,80,0.15);
}
...
.rp-step.done  .rp-step-label { color: #2d6b50; }
...
.rp-tag button {
  ...
  color: #2d6b50; font-size: 14px; line-height: 1;
  padding: 0; display: flex; align-items: center;
}
.rp-tag-input {
  border: none; outline: none;
  font-family: 'DM Sans', sans-serif;
  font-size: 13px; color: #1a3329;
...
export default function CreateResumePage() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      setDone(true);
      // ✅ redirect to nutritionist dashboard after success
      ...
      <div className="rp-page">
        ...
        <div className="rp-header">
          ...
          <p className="rp-subtitle">
            This is what clients will see when browsing nutritionists. Make it count.
          </p>
        </div>
            ...
            <>
              ...
              <div className="rp-row">
                <div className="rp-field">
                  ...
                  <input
                    className="rp-input"
                    placeholder="e.g. MSc Nutritional Science"
                ...
                <div className="rp-field">
                  ...
                  <input
                    className="rp-input"
                    placeholder="e.g. Wellness Clinic, Self-employed"
